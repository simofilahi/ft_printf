...
char    *apply_flags(t_var v, char *str, char *conv, int long long n)
{
    ...
    else if ((v.f_flag == '#' || v.s_flag == '#') && v.type == 'o')
...
void casting(t_var v, long long int *n, va_list args)
{
    ...
    else if (ft_strcmp(v.length, "ho") == 0)
    ...
    else if (ft_strcmp(v.length, "hho") == 0)
    ...
    else if (ft_strcmp(v.length, "lo") == 0)
    ...
    else if (ft_strcmp(v.length, "llo") == 0)
...
int     conv_o(char *s, va_list args)
{
    ...
    len = ft_strlen(str);
    // /*if ((v.f_flag == '#' || v.s_flag == '#') && (n > 0 || v.pres == 0)) 
    // {
    //     printf("hi\n");
    //     ft_putchar('0');
    //     len += 1;
